...
LIBRARY_SEMICOLON : ';' -> mode(DEFAULT_MODE), type(SEMICOLON) ;
LIBRARY_ONE_LINE_COMMENT : DOUBLE_SLASH TEXT ~[\r\n]* -> channel(COMMENTS), type(ONE_LINE_COMMENT) ;
...
DIRECTIVE_SIMPLE_IDENTIFIER : (LETTER | UNDERSCORE) (LETTER | UNDERSCORE | DECIMAL_DIGIT | DOLLAR_SIGN)* -> channel(DIRECTIVES) ;
DIRECTIVE_ESCAPED_IDENTIFIER : BACKSLASH ASCII_PRINTABLE_EXCEPT_SPACE+ WHITE_SPACE -> channel(DIRECTIVES) ;
...
TEXT_MACRO_SIMPLE_IDENTIFIER : (LETTER | UNDERSCORE) (LETTER | UNDERSCORE | DECIMAL_DIGIT | DOLLAR_SIGN)* -> channel(DIRECTIVES), type(DIRECTIVE_SIMPLE_IDENTIFIER), mode(MACRO_TEXT_MODE) ;
TEXT_MACRO_ESCAPED_IDENTIFIER : BACKSLASH ASCII_PRINTABLE_EXCEPT_SPACE+ WHITE_SPACE -> channel(DIRECTIVES), type(DIRECTIVE_ESCAPED_IDENTIFIER), mode(MACRO_TEXT_MODE) ;
DEFINE_DIRECTIVE_ONE_LINE_COMMENT : DOUBLE_SLASH TEXT ~[\r\n]* -> channel(COMMENTS), type(DIRECTIVE_ONE_LINE_COMMENT) ;
DEFINE_DIRECTIVE_BLOCK_COMMENT : SLASH_ASTERISK TEXT ASTERISK_SLASH -> channel(COMMENTS), type(DIRECTIVE_BLOCK_COMMENT) ;
DEFINE_DIRECTIVE_WHITE_SPACE : [ \t]+ -> channel(HIDDEN), type(DIRECTIVE_WHITE_SPACE) ;

mode CONDITIONAL_DIRECTIVE_MODE;
CONDITIONAL_MACRO_SIMPLE_IDENTIFIER : (LETTER | UNDERSCORE) (LETTER | UNDERSCORE | DECIMAL_DIGIT | DOLLAR_SIGN)* -> channel(DIRECTIVES), type(DIRECTIVE_SIMPLE_IDENTIFIER), mode(SOURCE_TEXT_MODE) ;
CONDITIONAL_MACRO_ESCAPED_IDENTIFIER : BACKSLASH ASCII_PRINTABLE_EXCEPT_SPACE+ WHITE_SPACE -> channel(DIRECTIVES), type(DIRECTIVE_ESCAPED_IDENTIFIER), mode(SOURCE_TEXT_MODE) ;
CONDITIONAL_DIRECTIVE_ONE_LINE_COMMENT : DOUBLE_SLASH TEXT ~[\r\n]* -> channel(COMMENTS), type(DIRECTIVE_ONE_LINE_COMMENT) ;
CONDITIONAL_DIRECTIVE_BLOCK_COMMENT : SLASH_ASTERISK TEXT ASTERISK_SLASH -> channel(COMMENTS), type(DIRECTIVE_BLOCK_COMMENT) ;
CONDITIONAL_DIRECTIVE_WHITE_SPACE : [ \t]+ -> channel(HIDDEN), type(DIRECTIVE_WHITE_SPACE) ;

mode MACRO_TEXT_MODE;
MACRO_TEXT : ~[\r\n\\]+ -> channel(DIRECTIVES) ;
MACRO_BACKSLASH_NEWLINE : BACKSLASH NEWLINE -> channel(DIRECTIVES) ;
MACRO_BACKSLASH_ESCAPE: BACKSLASH . -> channel(DIRECTIVES), type(MACRO_TEXT) ;
MACRO_ONE_LINE_COMMENT : DOUBLE_SLASH TEXT ~[\r\n]* -> channel(COMMENTS), type(DIRECTIVE_ONE_LINE_COMMENT) ;
MACRO_BLOCK_COMMENT : SLASH_ASTERISK TEXT ASTERISK_SLASH -> channel(COMMENTS), type(DIRECTIVE_BLOCK_COMMENT) ;
MACRO_NEWLINE : NEWLINE -> channel(HIDDEN), type(DIRECTIVE_NEWLINE), popMode ;

mode SOURCE_TEXT_MODE;
SOURCE_TEXT : ~[`\r\n\\]+ -> channel(DIRECTIVES) ;
SOURCE_GRAVE_ACCENT : '`' -> channel(DIRECTIVES), type(GRAVE_ACCENT), pushMode(DIRECTIVE_MODE) ;
SOURCE_BACKSLASH_ESCAPE: BACKSLASH . -> channel(DIRECTIVES), type(SOURCE_TEXT) ;
SOURCE_ONE_LINE_COMMENT : DOUBLE_SLASH TEXT ~[\r\n]* -> channel(COMMENTS), type(DIRECTIVE_ONE_LINE_COMMENT) ;
SOURCE_BLOCK_COMMENT : SLASH_ASTERISK TEXT ASTERISK_SLASH -> channel(COMMENTS), type(DIRECTIVE_BLOCK_COMMENT) ;
SOURCE_NEWLINE : NEWLINE -> channel(HIDDEN), type(DIRECTIVE_NEWLINE) ;
