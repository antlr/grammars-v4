...
metricsAggregation
    : LINE_ name parameterList
    ;

multMetrics
    : COMMA vectorOperation
    ;
...
labelNameList
    : LEFT_PAREN (name (COMMA name)*)? RIGHT_PAREN
    ;
...
fragment Time_high_and_version
    : TwoHexOctet
    ;

fragment Clock_seq_and_reserved
    : HexOctet
    ;

fragment Clock_seq_low
    : HexOctet
    ;
