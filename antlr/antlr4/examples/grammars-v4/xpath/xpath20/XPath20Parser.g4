...
options {
    tokenVocab = XPath20Lexer;
    superClass = XPath20ParserBase;
}
...
// [5]
simpleforclause
    : KW_FOR DOLLAR varname KW_IN exprsingle (COMMA DOLLAR varname KW_IN exprsingle)*
    ;
...
castexpr
    : unaryexpr (KW_CAST KW_AS singletype)?
    ;
...
functioncall
    : { this.IsFuncCall() }? qname OP (exprsingle ( COMMA exprsingle)*)? CP
    ;
