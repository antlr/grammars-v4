...
* The Go target fails with an "out of memory" condition for ManyStringsConcat.java.
Consequently, although the parser works for simple examples, it is currently
skipped in CI builds.
