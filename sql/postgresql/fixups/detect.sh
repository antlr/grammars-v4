...
do
	...
	dotnet trash parse -l $dir/*.g4 2>/dev/null | dotnet trash xpath ' //parserRuleSpec[./ruleBlock/ruleAltList/labeledAlt/alternative[count(./*) = 0]]/RULE_REF' | dotnet trash caret
done
