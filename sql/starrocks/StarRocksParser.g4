...
insertStatement
    : explainDesc? INSERT (INTO | OVERWRITE) (qualifiedName | (FILES propertyList) | (BLACKHOLE LEFT_PAREN RIGHT_PAREN)) partitionNames?
...
analyzeStatement
    : ANALYZE (FULL | SAMPLE)? TABLE qualifiedName (LEFT_PAREN qualifiedName  (COMMA qualifiedName)* RIGHT_PAREN)?
...
multiItemListPartitionDesc
    : PARTITION (IF NOT EXISTS)? identifier VALUES IN LEFT_PAREN listPartitionValueList (COMMA listPartitionValueList)* RIGHT_PAREN propertyList?
    ;
