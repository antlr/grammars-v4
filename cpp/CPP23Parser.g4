...
parser grammar CPP23Parser;

options {
    superClass = CPP14ParserBase;
    tokenVocab = CPP23Lexer;
}
...
conceptDefinition
    : Concept Identifier Assign constraintExpression Semi
    ;
...
parametersAndQualifiers
    : LeftParen parameterDeclarationClause? RightParen cvqualifierseq? refqualifier? exceptionSpecification? attributeSpecifierSeq? requiresClause?
    ;
...
parameterDeclaration
    : attributeSpecifierSeq? This? declSpecifierSeq (declarator | abstractDeclarator?) (
        Assign initializerClause
    )?
    ;
...
templateDeclaration
    : Template Less templateparameterList Greater requiresClause? declaration
    ;
