    ...
    ParsePragmas() {
        ...
        for (var j = 0; j < pragmas.length; j++) {
            ...
            for (var k = 0; k < pragmaTokens.length; k++) {
                ...
                var ct = new antlr4.CommonToken(null, t.type, antlr4.Token.DEFAULT_CHANNEL, t.start, t.stop);
                ct.text = t.text;
                ct.line = t.line;
                ct.column = t.column;
            ...
            var eof = new antlr4.CommonToken(null, antlr4.Token.EOF, antlr4.Token.DEFAULT_CHANNEL, -1, -1);
            defaultChannelTokens.push(eof);
            var tokenSource = new antlr4.CommonTokenStream(new antlr4.ListTokenSource(defaultChannelTokens));
            var parser = new AdaParser(tokenSource);
