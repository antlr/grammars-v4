...
--     PART 3: CONTEXT SUGGESTS  "SHORT_INTEGER" .

-- APPLICABILITY CRITERIA:
--     THIS TEST IS APPLICABLE TO IMPLEMENTATIONS WHICH SUPPORT
--     THE TYPE "SHORT_INTEGER".
--
--     IF "SHORT_INTEGER" IS NOT SUPPORTED, THEN THE SUBTYPE
--     DECLARATION FOR T MUST BE REJECTED.
...
PROCEDURE B55B09D IS

     SUBTYPE  T  IS  SHORT_INTEGER;                    -- N/A => ERROR.
