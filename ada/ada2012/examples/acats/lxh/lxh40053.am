...
--         No_Exceptions
--      disallows exceptions in the units previously compiled into
--      the program library.
--
-- TEST DESCRIPTION:
...
--      defined.
--      The configuration pragma must be processed after LXH40050.A has
--      been processed.
--      To build this test:
--        1) Compile LXH40050.A
--        2) Compile LXH40051.A
--        3) Compile LXH40052.A
--        4) Compile LXH40053.AM
--        5) Attempt to build an executable image: LXH4005
...
with LXH4005_0;
with LXH4005_1;
procedure LXH40053 is

  procedure Expect_To_Fail is
  begin
    LXH4005_0.Raise_One;
  end Expect_To_Fail;
