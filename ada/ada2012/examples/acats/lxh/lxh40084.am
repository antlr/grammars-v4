...
--      disallows the use of Unchecked_Conversion in the units previously
...
--      defined.
--      The configuration pragma must be processed after LXH40080.A has
--      been processed.
--      To build this test:
--        1) Compile LXH40080.A
--        2) Compile LXH40081.A
--        3) Compile LXH40082.A
--        4) Compile LXH40083.A
--        5) Compile LXH40084.AM
--        6) Attempt to build an executable image: LXH4008
--        7) If an executable image results, run it.
--
-- TEST FILES:
...
with LXH4008_0;
with LXH4008_2;
procedure LXH40084 is
begin

  if LXH4008_2(False) then
    LXH4008_0;
  end if;
