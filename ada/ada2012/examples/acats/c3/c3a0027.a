...
procedure C3A0027 is
   ...
   procedure Use_It (Obj : access protected function (X : Float) return Float) is
...
begin
   Report.Test ("C3A0027", "Check that Constraint_Error is raised when a null " &
   ...
   begin
      declare
         O_1 : not null access protected function (X : Float) return Float;    -- Test (default initialization).
      begin
   ...
   begin
      declare
         O_2 : not null access protected function (X : Float) return Float := Null_Init;      -- Test (initialization).
      begin
   ...
   declare
      O_3 : not null access protected function (X : Float) return Float := Double_Init;
   begin
   ...
   declare
      O_4 : not null access protected function (X : Float) return Float := Double_Init;
   begin
   ...
   declare
      type Table is array (Integer range <>) of
        not null access protected function (F: Float) return Float;
   ...
   begin
      declare
         type Rec is record
            C : not null access protected function (X : Float) return Float := Null_Init;
         end record;
   ...
   declare
      type Rec is record
         C : not null access protected function (X : Float) return Float := Double_Init;
      end record;
      RO_5 : Rec;
   begin
   ...
   begin
      declare
         type Rec (D : not null access protected function (X : Float) return Float) is
            record
               Dummy : Integer := 0;
            end record;
   ...
   begin
      declare
         type Rec (D : not null access protected function (X : Float) return Float := Null_Init) is
            limited record
               Dummy : Integer := 0;
            end record;
   ...
   declare
      procedure Proc_1 (F : not null access protected function (X : Float) return Float) is
      begin
         Use_It (F);
      end Proc_1;
   begin
   ...
   begin
      declare
         procedure Proc_2 (F :
            not null access protected function (X : Float) return Float := Null_Init) is
         begin
            Use_It (F);
         end Proc_2;
      begin
   ...
   declare
      function Func_2 (F : Acc_Ptr)
         return not null access protected function (X : Float) return Float is
      begin
         return Result : not null access protected function (X : Float) return Float
            := PO.Double'Access do
            Result := F;
         end return;
      end Func_2;
   ...
   declare
      generic
         F : not null access protected function (X : Float) return Float := Null_Init;
      package GPack is
         procedure User;
      end GPack;
