...
begin
   Report.Test ("C3A0026", "Check that Constraint_Error is raised when a null " &
   ...
   begin
      declare
         O_1 : not null access function (X : Float) return Float;    -- Test (default initialization).
      begin
   ...
   begin
      declare
         O_2 : not null access function (X : Float) return Float := Null_Init;      -- Test (initialization).
      begin
   ...
   declare
      type Table is array (Integer range <>) of
        not null access function (F: Float) return Float;
   ...
   begin
      declare
         type Rec (D : not null access function (X : Float) return Float) is
            record
               Dummy : Integer := 0;
            end record;
   ...
   begin
      declare
         type Rec (D : not null access function (X : Float) return Float := Null_Init) is
            limited record
               Dummy : Integer := 0;
            end record;
   ...
   declare
      procedure Proc_1 (F : not null access function (X : Float) return Float) is
      begin
         Use_It (F);
      end Proc_1;
   begin
   ...
   begin
      declare
         procedure Proc_2 (F :
            not null access function (X : Float) return Float := Null_Init) is
         begin
            Use_It (F);
         end Proc_2;
      begin
   ...
   declare
      function Func_1 (F : Acc_Ptr)
          return not null access function (X : Float) return Float is
      begin
         return F;
      end Func_1;
   ...
   declare
      function Func_2 (F : Acc_Ptr)
         return not null access function (X : Float) return Float is
      begin
         return Result : not null access function (X : Float) return Float
                := Double'Access do
            Result := F;
         end return;
      end Func_2;
