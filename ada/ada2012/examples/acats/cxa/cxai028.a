...
begin
   ...
   declare
      ...
      My_Constant_Reference : My_Bounded_Ordered_Maps.Constant_Reference_Type :=
   ...
   begin
      ...
      -- Normal call:
      Test (Value    =>
               My_Bounded_Ordered_Maps.Constant_Reference(My_Map_1,
      ...
      Test_and_Mod (
            Value    =>
               My_Bounded_Ordered_Maps.Reference(My_Map_1,
                   Key => My_Key_Type(1)).Element.all,
            Expected => Value_In_Array (1),
