...
procedure CXAI011 is
   ...
   package My_Bounded_Doubly_Linked_Lists is new
     Ada.Containers.Bounded_Doubly_Linked_Lists
     (Element_Type => My_Float); -- Default =

   package My_Sorting is new
     My_Bounded_Doubly_Linked_Lists.Generic_Sorting
...
begin
   ...
   for I in reverse Array_Bounds_Type loop
      ...
      if I mod 2 = 0 then
         ...
         My_Cursor_2 := My_Bounded_Doubly_Linked_Lists.Previous
   ...
   declare
      ...
      procedure My_Process
        (Position : in My_Bounded_Doubly_Linked_Lists.Cursor) is
      begin
   ...
   My_List_2.Swap
     (I => My_List_2.Last,
      J => My_Bounded_Doubly_Linked_Lists.Previous
   ...
   if My_Bounded_Doubly_Linked_Lists.Element (Position => My_Cursor_2) /=
     My_Default_Value then
      ...
      Report.Comment ("Value =" &
                      My_Float'Image(My_Bounded_Doubly_Linked_Lists.Element (
                          Position => My_Cursor_2)) &
   ...
   for I in Ada.Containers.Count_Type range Num_Tests + 3 .. Capacity_Reqd loop
      ...
      My_Cursor_2 := Big_List.Find
                       (Item => Value_In_Array ((I mod Num_Tests) + 1));
