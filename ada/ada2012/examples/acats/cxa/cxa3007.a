...
--     Ada.Wide_Wide_Characters.Handling produce correct results when provided
--     arguments from Wide_Wide_Character.
--
-- TEST DESCRIPTION:
--     This test checks the character classification functions of package
--     Ada.Wide_Wide_Characters.Handling.  A loop is constructed to test the
--     functions for the first 256 positions of Wide_Wide_Character,
--     core Greek and Cyrillic characters, and a few selected other characters.
--     (Testing all values of Wide_Wide_Character would require a file of almost
...
--
-- CHANGE HISTORY:
--      21 Mar 14   RLB     Created test out of CXA3007.
--!
with Ada.Characters.Conversions;
with Ada.Wide_Wide_Characters.Handling;
with Report;

procedure CXA3007 is
   ...
   subtype Wide_Wide_Character_Range is Wide_Wide_Character range Wide_Wide_Character'First ..
    Wide_Wide_Character'Last;

   type Classifications_Array_Type is array (Wide_Wide_Character_Range range <>) of
     Classifications_Set_Type;


   subtype Character_Wide_Wide_Character_Subset is Wide_Wide_Character range
     Wide_Wide_Character'First ..
     Ada.Characters.Conversions.To_Wide_Wide_Character (Character'Last);

   Character_Classifications_Array : constant Classifications_Array_Type
    (Character_Wide_Wide_Character_Subset) :=
    (
   ...
   subtype Core_Greek_1_Wide_Wide_Character_Subset is Wide_Wide_Character range
     Wide_Wide_Character'Val (16#391#) .. Wide_Wide_Character'Val (16#3A1#);

   Core_Greek_1_Classifications_Array : constant Classifications_Array_Type
    (Core_Greek_1_Wide_Wide_Character_Subset) :=
    (
   ...
   subtype Core_Greek_2_Wide_Wide_Character_Subset is Wide_Wide_Character range
     Wide_Wide_Character'Val (16#3A3#) .. Wide_Wide_Character'Val (16#3A9#);

   Core_Greek_2_Classifications_Array : constant Classifications_Array_Type
    (Core_Greek_2_Wide_Wide_Character_Subset) :=
    (
   ...
   subtype Core_Greek_3_Wide_Wide_Character_Subset is Wide_Wide_Character range
     Wide_Wide_Character'Val (16#3B1#) .. Wide_Wide_Character'Val (16#3C9#);

   Core_Greek_3_Classifications_Array : constant Classifications_Array_Type
    (Core_Greek_3_Wide_Wide_Character_Subset) :=
    (
   ...
   subtype Core_Cyrillic_Wide_Wide_Character_Subset is Wide_Wide_Character range
     Wide_Wide_Character'Val (16#400#) .. Wide_Wide_Character'Val (16#45F#);

   Core_Cyrillic_Classifications_Array : constant
    Classifications_Array_Type (Core_Cyrillic_Wide_Wide_Character_Subset) :=
    (
   ...
   procedure Test_Character
     (WC                  : in Wide_Wide_Character;
      Classifications_Set : in Classifications_Set_Type) is
   begin

      if Ada.Wide_Wide_Characters.Handling.Is_Control (WC)/=
        Classifications_Set (Control) then

         Report.Failed
           ("Wrong Is_Control for position " &
            Integer'Image (Wide_Wide_Character'Pos (WC)));

      end if;

      if Ada.Wide_Wide_Characters.Handling.Is_Letter (WC)/=
      ...
      if Ada.Wide_Wide_Characters.Handling.Is_Lower (WC)/=
      ...
      if Ada.Wide_Wide_Characters.Handling.Is_Upper (WC)/=
     ...
     if Ada.Wide_Wide_Characters.Handling.Is_Digit (WC)/=
      ...
      -- same value.
      if Ada.Wide_Wide_Characters.Handling.Is_Decimal_Digit (WC)/=
        Classifications_Set (Digit) then
     ...
     if Ada.Wide_Wide_Characters.Handling.Is_Hexadecimal_Digit (WC)/=
     ...
     if Ada.Wide_Wide_Characters.Handling.Is_Alphanumeric (WC)/=
     ...
     if Ada.Wide_Wide_Characters.Handling.Is_Special (WC)/=
     ...
     if Ada.Wide_Wide_Characters.Handling.Is_Line_Terminator (WC)/=
     ...
     if Ada.Wide_Wide_Characters.Handling.Is_Mark (WC)/=
      ...
      if Ada.Wide_Wide_Characters.Handling.Is_Other_Format (WC)/=
      ...
      if Ada.Wide_Wide_Characters.Handling.Is_Punctuation_Connector (WC)/=
      ...
      if Ada.Wide_Wide_Characters.Handling.Is_Space (WC)/=
      ...
      if Ada.Wide_Wide_Characters.Handling.Is_Graphic (WC)/=
...
begin
   ...
   for I in Character_Wide_Wide_Character_Subset loop
   ...
   Test_Character
      (WC                  => Wide_Wide_Character'Val (16#130#), -- Large_Dotted_I
       Classifications_Set => Large_Dotted_I_Classifications_Set);

   Test_Character
      (WC                  => Wide_Wide_Character'Val (16#131#), -- Small_Dotless_I
       Classifications_Set => Small_Dotless_I_Classifications_Set);

   for I in Core_Greek_1_Wide_Wide_Character_Subset loop
   ...
   for I in Core_Greek_2_Wide_Wide_Character_Subset loop
   ...
   for I in Core_Greek_3_Wide_Wide_Character_Subset loop
   ...
   for I in Core_Cyrillic_Wide_Wide_Character_Subset loop
