...
begin
   ...
   begin
      ...
      -- Normal call:
      Test (Value    =>
               My_Bounded_Hashed_Maps.Constant_Reference(My_Map_1,
      ...
      Test_and_Mod (
            Value    =>
               My_Bounded_Hashed_Maps.Reference(My_Map_1,
                   Key => My_Key_Type(1)).Element.all,
            Expected => Value_In_Array (1),
   ...
   begin
      ...
      for I in Array_Bounds_Type loop
         ...
         if My_Bounded_Hashed_Maps.Element (Position => My_Cursor_1) /= 0.0 then
