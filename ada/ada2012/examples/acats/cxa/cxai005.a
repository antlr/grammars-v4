...
begin
   ...
   declare
      ...
      procedure My_Process
        (Position : in My_Hashed_Sets.Cursor) is
      begin
   ...
   My_Set_3 := My_Hashed_Sets.Intersection
                 (Left  => My_Set_1,
                  Right => My_Set_2);
   ...
   if My_Hashed_Sets.Element (Position => My_Cursor_3) /= My_Default_Value
     then
   ...
   My_Set_3 := My_Hashed_Sets.Difference
                 (Left  => My_Set_1,
                  Right => My_Set_2);
   ...
   My_Set_3 := My_Hashed_Sets.Symmetric_Difference
                 (Left  => My_Set_1,
                  Right => My_Set_3);
