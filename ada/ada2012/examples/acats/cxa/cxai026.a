...
begin
   ...
   declare
      ...
      My_Constant_Reference :
                      My_Bounded_Doubly_Linked_Lists.Constant_Reference_Type :=
   ...
   begin
      ...
      -- Normal call:
      Test (Value    =>
               My_Bounded_Doubly_Linked_Lists.Constant_Reference(My_List_1,
      ...
      Test_and_Mod (
            Value    =>
               My_Bounded_Doubly_Linked_Lists.Reference(My_List_1,
                   Position => My_Cursor_1).Element.all,
            Expected => Value_In_Array (1),
