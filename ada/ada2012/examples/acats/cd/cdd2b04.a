...
--      of stream elements specified by their Stream_Size attribute. Part 4:
--      aspect specifications, non-confirming values.
--
-- TEST DESCRIPTION:
...
procedure CDD2B04 is
   ...
   type Basic_Int is range -99 .. 99
      with Stream_Size => Stream_Element_Size*1;       -- N/A => ERROR. {1:4;1}

   type Big_Int is range -999999 .. 999999
      with Stream_Size => Stream_Element_Size*4;       -- N/A => ERROR. {1:4;1}
...
begin
   Report.Test ("CDD2B04", "Check that the default stream attributes read " &
                           "and write the specified number of stream " &
                           "elements. Part 4: aspect specifications with " &
                           "non-confirming stream sizes");
