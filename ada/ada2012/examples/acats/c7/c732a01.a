...
--      15 Jan 15   RLB     Updated test to use foundation, cleaned up wording,
--                          removed uninitialized memory hacks.
...
procedure C732A01 is
   ...
   procedure Test_Default_Initialisation is
      ...
      procedure Do_Default_Initialisation_Inside_The_Abstraction is
         ...
         Default_Initialised_Change : Bells.Change_Constrained_Type :=
      ...
      begin
         ...
         if Bells.Each_Bell_Occurs_Once (Default_Initialised_Change) then
            Report.Failed
              ("Incorrect default initialisation - Inside");
      ...
      begin
         ...
         if Bells.Each_Bell_Occurs_Once (Default_Initialised_Change) then
            Report.Failed
              ("Incorrect default initialisation - Outside");
         end if;
   ...
   begin
      ...
      begin
         ...
         Report.Failed
           ("Inside default initialisation should have raised " &
            "Assertion_Error");
   ...
   procedure Test_Invalid_Change is
      ...
      procedure Do_Invalid_Change is
         ...
         My_Invalid_Change : Bells.Change_Constrained_Type :=
      ...
      begin
         ...
         if Bells.Each_Bell_Occurs_Once (My_Invalid_Change) then
            Report.Failed
              ("Incorrect explicit initialisation");
         end if;
   ...
   procedure Test_Valid_Change is
      ...
      My_Change : Bells.Change_Constrained_Type := Bells.Rounds;
   ...
   procedure Test_Invalid_In_Out_Parameter is
      ...
      procedure Do_Invalid_In_Out_Parameter is
         ...
         My_Invalid_Grandsire_Change : Bells.Change_Constrained_Type :=
                                                       Bells.Rounds;
   ...
   procedure Test_Valid_In_Out_Parameter is
      ...
      My_Grandsire_Change : Bells.Change_Constrained_Type := Bells.Rounds;
