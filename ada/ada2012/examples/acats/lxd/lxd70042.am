...
--      pragma Restrictions (No_Terminate_Alternatives) is included.
--
-- TEST DESCRIPTION:
--      Pragma Restrictions (No_Terminate_Alternatives) is called out in a 
--      separate text file.  A library level package which contains a task 
--      which has a terminate alternative is declared in another file.   
--      A main unit which "withs"  the package is declared in a third file.
...
--          LXD70040.A     A text file containing the Restrictions pragma
...
--      made to include a task with terminate alternatives when the partition
--      has a Restriction of No_Terminate_Alternatives
--
...
with LXD70041;   -- include the tasks
with Report;
         
procedure LXD70042 is


begin -- LXD70042

   Report.Test ("LXD70042", "Tasking Restrictions: " &
