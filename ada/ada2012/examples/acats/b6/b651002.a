...
--     Case 2: aspect No_Return.
--
-- CHANGE HISTORY:
--     31 Mar 17   RLB     Created test.
--
--!
procedure B651002 is
   ...
   package Ren_Pack is
      ...
      procedure Inst_Raise_Error is new Pack.Generic_Raise_Error (Message);

      procedure Inst_Print_Error is new Pack.Generic_Print_Error (Message);
