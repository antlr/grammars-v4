...
package BA12018_Parent.T5 is

    X : Integer renames BA12018_0.Obj; -- ERROR: {25;1} Used in visible part.

    Y : BA12018_0.Rec;                 -- ERROR: { 9;1} Used in visible part.

    Z : BA12018_0.BA12018_2.R;         -- ERROR: { 9;1} Used in visible part.

private

    S : Integer := BA12018_0.Func (12); -- OK. {20;6}

    T : Float := BA12018_0.BA12018_1.Func (12); -- OK. {20;6}

end BA12018_Parent.T5;
