...
--*
--
-- FUNCTION NAME: CXB30170
--
-- FUNCTION DESCRIPTION:
--      This C function calls back into Ada passing through the parameters.
--      It returns the value of the first parameter plus CXB3017_Global.
--
-- INPUTS:
...
--      This also reads the value of the global CXB3017_Global.
--
-- PROCESSING:
...
--
-- OUTPUTS:
--      The value of num1 after the call to the Ada routine CXB3017_Ada_Proc
--      summed with CXB3017_Global is returned through function name.
--      Parameters num2-num4 now point to values that are the values of
--      parameters num2-numb4 modified by the Ada routine CXB3017_Ada_Proc.
--
-- OBJECTIVE
--      See CXB30172.AM.
--
...
extern int CXB30171_Global;
/* Ada declaration:
 *   Global : Interfaces.C.Int := 0
 *      with Export, Convention => C, External_Name => "CXB30171_Global";
 */
int CXB30170 (int num1, short* num2, float* num3, double* num4)
...
/*                                                                       */
/*  int CXB30170 (num1, num2, num3, num4)                                */
/*     int     num1;                                                     */
/*     short*  num2;                                                     */
/*     float*  num3;                                                     */
/*     double* num4;                                                     */
...
{
   int return_value = 0;
   extern void CXB30171_Ada_Doubler
    ...
    *      with Export, Convention => C, External_Name => "CXB30171_Ada_Doubler";
    */

   CXB30171_Ada_Doubler(&num1, num2, num3, num4);
   return num1 + CXB30171_Global;
}
