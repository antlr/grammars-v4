...
--      The files CXB30240.C must be compiled with a C
...
--
--      Note that the C code included in CXB30240.C conforms
...
procedure CXB30241 is
   ...
   procedure C_Format_Variant (Item : C_Multi_Type_Access;
     ...
     with Import,
          Convention => C,
          External_Name => ImpDef.CXB30240_External_Name;
