...
export default abstract class CSharpLexerBase extends Lexer {
    ...
    PeekMode(): number {
        const stack = (this as any)._modeStack as number[] | undefined;
        return (stack && stack.length > 0) ? stack[stack.length - 1] : Lexer.DEFAULT_MODE;
    }
    ...
    LookAheadIsRBrace1(): boolean    { return this._input.LA(1) === 125; }
    LookAheadIsNotLBrace2(): boolean { return this._input.LA(2) !== 123; }
