...
/* 34 */
ifStatement :
	'if'   LPAREN   logicalExpression RPAREN  
...
elseIfStatement 	: 
	...
	('elseif'   | 'else'   'if'  )
	LPAREN   logicalExpression   RPAREN   'then'   seos
	(wholeStatement)*
...
formatedit :
  ...
  ;
editElement:
  FCON | SCON | HOLLERITH | NAME | LPAREN fmtSpec RPAREN ;
...
ncExpr : lexpr0 ( concatOp lexpr0)* ; // concatenation
...
WS : WHITE ->skip // White spaces or empty lines
	;
