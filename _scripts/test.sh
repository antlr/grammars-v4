...
setupdeps()
{
    ...
    then
        ...
        dotnet tool install -g trgen --version 0.20.3
        dotnet tool install -g triconv --version 0.20.3
        dotnet tool install -g trxml2 --version 0.20.3
        dotnet tool install -g trwdog --version 0.20.3
    case "${unameOut}" in
